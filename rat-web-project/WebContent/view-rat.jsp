		...
		<div class="table-responsive">
			<table class="table-striped">
				...
				<c:forEach var="tempPaymentsList" items="${THE_RAT.getPayments() }">
					<tr>
						<td class="col-sm-3 nopadding"><c:out value="${tempPaymentsList.getName()}" /></td>
						<td class="col-sm-3 nopadding"><c:out value="${tempPaymentsList.getSourceOfData()}" /></td>
						<td class="col-sm-3 nopadding"><c:out value="${tempPaymentsList.getEvent()}" /></td>
						<td class="col-sm-3 nopadding"><c:out value="$ ${tempPaymentsList.getAmount()}" /></td>
					</tr>
